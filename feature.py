...
class Feature:
    def __init__(self, train_size, list_of_data, forecast):
    ...
    def normalize(self):
        ...
        self.data_normalized = pd.DataFrame(self.scaler.fit_transform(self.data.values))

        Logger.log('Feature array normalized')
    ...
    def get_label_set(self, index):
        return (self.labels[index])[:self.index]
